import 'package:donut_app_2b_aguilar/screen/login/verification_page.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:donut_app_2b_aguilar/common/color_extension.dart';
import 'package:donut_app_2b_aguilar/common_widget/round_button.dart';
import 'package:donut_app_2b_aguilar/common_widget/round_text_field.dart';
import 'package:donut_app_2b_aguilar/screen/login/sign_up_screen.dart';
import 'package:donut_app_2b_aguilar/pages/home_page.dart';
import 'package:donut_app_2b_aguilar/screen/login/forget_password_screen.dart';
                              ...
                              child: MaterialButton(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Image.asset('lib/icons/fb.png',width:25, height: 25,),//NO PONER / AL INICIO
                                  const Expanded(
                                    child: Text(
                            ...
                            padding:const EdgeInsets.symmetric(horizontal:20),
                              child: MaterialButton(
                                ...
                                child: Row(
                                  children: [
                                    const SizedBox(width: 15,),
                                    Image.asset('lib/icons/google.png',width:25, height: 25,),//NO PONER / AL INICIO
                                  Expanded(
                                    child: Text(
